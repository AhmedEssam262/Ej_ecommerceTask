    ...
    function EditForm(props){
        ...
        return(
            <div className={"container my-5"} >
                {AddMessage && <AddSuccessMessage message="Product is added or updated Successfully."/>}

                <div className="input-group mb-3">
                    <div className={"row w-100 justify-content-center" }>
                        <div className="col-xl-2 col-6 input-group-prepend">
                            <span className={`${styling.productFlag} input-group-text`} id="basic-addon1">Product Name</span>
                        </div>
                        <div className={"col-xl-6 col-6 "}>
                            <input
                                ...
                                defaultValue={props.data?props.data.productName:null}
                                   ...
                                   type="text" className={`${styling.inputElement} form-control border-start-0 border-end-0 border-top-0 border-black rounded-0 mx-2 p-0`} aria-label="Username" aria-describedby="basic-addon1"/>
                        </div>
                    </div>
                </div>

                <div className={"input-group mb-3"}>
                    <div className={"row w-100 justify-content-xl-center justify-content-start" }>
                            <div className="col-xl-1 col-4 input-group-prepend">
                                <span className={`${styling.productFlag} input-group-text`} id="basic-addon1">Price</span>
                            </div>
                        ...
                        <div className={"col-xl-3 col-5"}>
                                <input
                                    ...
                                    defaultValue={props.data?props.data.price:null}
                                     type="text" className={`${styling.inputElement} form-control border-start-0 border-end-0 border-top-0 border-black rounded-0 mx-2 p-0`}   aria-label="Amount (to the nearest dollar)"
                                />
                        </div>
                ...
                <div className={"input-group mb-3"}>
                    <div className={"row w-100 justify-content-xl-center justify-content-start" }>
                        <div className="col-xl-1 col-4 input-group-prepend">
                            <span className={`${styling.productFlag} input-group-text`} id="basic-addon1">Old Price</span>
                        </div>
                        <div className={"col-xl-1 col-1"} ></div>
                        <div className={"col-xl-3 col-5"}>
                            <input
                ...
                <div className={"input-group mb-3"}>
                    <div className={"row w-100 justify-content-xl-center justify-content-start" }>
                        <div className="col-xl-1 col-4 input-group-prepend">
                            <span className={`${styling.productFlag} input-group-text`} id="basic-addon1">Discount</span>
                        </div>
                        <div className={"col-xl-1 col-1"} ></div>
                        <div className={"col-xl-3 col-5"}>
                            <input
                ...
                <div className="input-group">
                    <div className={"row w-100 justify-content-xl-center justify-content-start" }>
                            <div className={"col-xl-2 col-6"}>
                                <span className={`${styling.productFlag} input-group-text`} id="basic-addon1">Product description</span>
                            </div>
                            <div className={"col-xl-6 col-6"}>
                                <textarea
                                    onChange={(e) => setDescription(e.target.value)}
                                    defaultValue={props.data?props.data.description:null}
                                    className={`${styling.inputElement} form-control`} aria-label="With textarea"></textarea>
                            </div>
                        </div>
                </div>
                ...
                <div className="input-group mb-3">
                    <div className={"row w-100 justify-content-xl-center justify-content-start" }>
                        ...
                        <span className={`${styling.productFlag} input-group-text`} id="basic-addon1">image</span>
                        </div>
                        <div className={"col"}>
                        <div className="custom-file">
                            ...
                            <div className={"mt-3"}>
                                <img src={myImage} style={{ height: "80px" ,width:"80px"}} alt="product" />
                            </div>
